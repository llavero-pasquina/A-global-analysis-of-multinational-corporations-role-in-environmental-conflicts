...
#Companies named 
DELETE <- c("Pvt. Ltd.","Consorcio","Waste Management","Subsidiary","GS España", "US",
            "Promotora del Desarrollo de América Latina ","Fomento",
            "Empresa Nacional de Minería ",
            "U.S. Bureau of Indian Affairs ","Berkeley Minera España S.A","Ingeniería Civil Internacional S.A")
